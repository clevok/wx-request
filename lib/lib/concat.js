...
var Connect = /** @class */ (function () {
     ...
     */
    Connect.prototype.use = function () {
        var _a;
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            params[_i] = arguments[_i];
        }
        (_a = this.middlewares).push.apply(_a, params);
    };
    /**
     * 中间件合并方法，将中间件数组合并为一个中间件
     * @return {Function}
     */
    Connect.prototype.compose = function () {
        var _this = this;
        // 将middlewares合并为一个函数，该函数接收一个ctx对象
        return function (ctx) { return __awaiter(_this, void 0, void 0, function () {
            function createNext(middleware, oldNext) {
                return function () {
                    return middleware.apply(void 0, __spreadArrays(ctx, [oldNext]));
                };
            }
            var len, next, i, currentMiddleware;
    ...
    Connect.prototype.done = function () {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            params[_i] = arguments[_i];
        }
